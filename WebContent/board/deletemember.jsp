   ...
   try{
      if(master.equals(id))
      {
         ...
         if(result == 1)
         {
            ...
            notice1 = membername +"(" +memberid +")"+"님을 보드(" + session.getAttribute("boardtitle")  + ")에서 퇴장시켰습니다.";
            notice2 = "보드(" + session.getAttribute("boardtitle")  + ")에서 퇴장당했습니다.";
